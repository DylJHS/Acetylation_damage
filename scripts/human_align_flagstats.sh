#!/bin/bash
#SBATCH --job-name=human_align_results
#SBATCH --output=/hpc/shared/onco_janssen/dhaynessimmons/logs/human_align_results-%j.out
#SBATCH --error=/hpc/shared/onco_janssen/dhaynessimmons/logs/human_align_results-%j.err
...
# Define paths
RESULTS_DIR="/hpc/shared/onco_janssen/dhaynessimmons/results/fly_acetylation_damage/human_alignments"
