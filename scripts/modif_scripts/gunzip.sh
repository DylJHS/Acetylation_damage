...
#SBATCH --output=/hpc/shared/onco_janssen/dhaynessimmons/projects/fly_acetylation_damage/logs/gunzip-%j.out
#SBATCH --error=/hpc/shared/onco_janssen/dhaynessimmons/projects/fly_acetylation_damage/logs/gunzip-%j.err
...
if [[ $multi_ext == "tar.gz" ]]; then
    ...
    echo "Unzipping..."
    tar -xzf "${FILE}" -C /hpc/shared/onco_janssen/dhaynessimmons/projects/fly_acetylation_damage/data/
else
